...
export function GET() {
  ...
  const lines = [
    ...
    "",
    "BWG lists wine grapes priced per ton and bulk wine priced per gallon. Buyers and sellers arrange price, payment and delivery directly; BWG does not charge fees, process payments or ship product. Sellers can hide their identity under NDA.",
    "",
    "## Marketplaces",
    "",
    ...
    "## Answers",
    "",
    `- [FAQ](${absoluteUrl("/faq")}): how BWG works, NDA listings, pricing, payment, alerts`,
