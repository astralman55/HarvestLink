...
- **Photography (Decision 57):** six vetted stock photos on the homepage (hero, marketplace cards, confidential section, how it works, closing banner) and one per blog post (hero and card thumbnail, also on the blog index and homepage blog cards), self-hosted as optimized WebP; credits in `docs/image-credits.md`.
