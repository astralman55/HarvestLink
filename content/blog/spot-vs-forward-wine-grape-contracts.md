---
title: "Spot Market vs Forward Contracts for Wine Grapes: What to Know"
metaTitle: "Wine Grape Contracts: Spot vs Forward Explained"
slug: "spot-vs-forward-wine-grape-contracts"
description: "How spot and forward wine grape contracts differ, what terms to include (tonnage, price per ton, brix, delivery), and how to plan multi-year supply."
primaryKeyword: "wine grape contracts"
secondaryKeywords: ["grape purchase agreement", "forward contract wine grapes", "spot market grapes", "multi-year grape contract", "grape contract terms"]
category: "Wine Grapes"
datePublished: "2026-09-19"
dateModified: "2026-09-19"
author: "Andrew L."
status: "published"
quickAnswer: "A spot purchase buys grapes for the current harvest at a price negotiated now, while a forward or multi-year contract fixes tonnage and pricing terms in advance. Forward contracts give both sides predictability. Spot deals give flexibility, especially when the market is changing."
faq:
  - q: "How long do wine grape contracts last?"
    a: "They range from a single harvest to many years. Multi-year agreements commonly specify a block or vineyard, a tonnage, and how the price is set each year."
  - q: "What is a spot price for grapes?"
    a: "A spot price is what a buyer and grower agree to for the current harvest, without a longer commitment. It reflects conditions right now, including supply, demand, and quality."
  - q: "Can a buyer reject grapes?"
    a: "Only under the terms of the agreement. Contracts usually spell out quality specs such as brix range and condition at delivery, how fruit is sampled, and what happens if it does not meet them."
  - q: "Should I lock in a price in a falling market?"
...
- **Tiered by brix.** The price steps up or down if brix at delivery is above or below a range. See [what brix means](/blog/what-is-brix-in-winemaking).
...
If you are buying, read [how to buy wine grapes](/blog/how-to-buy-wine-grapes) and use the [tons to gallons calculator](/blog/gallons-of-wine-per-ton-of-grapes) to size your order. If you are selling, [list your grapes](/sell) openly or confidentially.
